              ...
              <RevealItem key={project.slug} className="h-full" variants={compactMotion ? stationaryCard : undefined}>
                ...
                >
                  ...
                  <div className="flex min-w-0 flex-1 flex-col p-5 sm:p-7">
                    ...
                    <h3 className={cn('mt-4 max-w-full break-words text-[clamp(1.8rem,9vw,2.25rem)] leading-[0.98] tracking-[-0.05em] text-balance sm:text-3xl', project.slug === 'ombu-cafe' && 'font-semibold italic', project.slug === 'aster-automoviles' && 'font-semibold uppercase', project.slug === 'cimbra-estudio' && 'font-bold')}>{project.name}</h3>
