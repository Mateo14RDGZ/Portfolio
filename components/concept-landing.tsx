...
function AsterLanding() {
  const vehicles = [
    { name: 'Arco E-9', type: 'SUV eléctrico', copy: '612 km de autonomía estimada', image: '/concepts/aster-hero.webp', imageClass: 'object-[58%_center]' },
    { name: 'Norte S1', type: 'Gran turismo', copy: 'Tracción total y 4 plazas', image: '/concepts/aster-vehicle-norte-s1.webp', imageClass: 'object-center' },
    { name: 'Vector 4', type: 'SUV familiar', copy: 'Espacio, tecnología y carga rápida', image: '/concepts/aster-vehicle-vector-4.webp', imageClass: 'object-center' },
  ]
